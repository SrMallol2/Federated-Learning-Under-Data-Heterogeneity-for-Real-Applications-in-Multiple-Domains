...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset", type=str, default="SynReg-user5-alpha0.001-ratio0.7")
    parser.add_argument("--algorithms", type=str, default="FedGen", help='algorithm names separate by comma')
    ...
    parser.add_argument("--top_n", type=float, default=-5)
    parser.add_argument("--num_users", type=int, default=20, help='number of active users per epoch.')
