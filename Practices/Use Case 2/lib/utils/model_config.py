CONFIGS_ = {
    ...
    'flags': ([6, 16, 'F'], 1, 3, 480, 32),
    'flags-regression-cnn': ([6, 16, 'F'], 1, -1, 480, 32),
    'flags-regression-lstm': (['LSTM-480', 'F'], 6, -1, 480, 32),
    'synthetic-regression-cnn': ([6, 16, 'F'], 1, 1, 32, 32),
}
...
GENERATORCONFIGS = {
    ...
    'flags': (256, 32, 5, 3, 32),
    'flags-regression': (256, 32, 5, -1, 32),
    'synthetic-regression': (256, 32, 5, 1, 32),
}
    ...
    'flags':
        {
            ...
            'ensemble_eta': 1,      # diversity loss
            'unique_labels': 3,
            'steps': 1,    # number of future steps
            'lookback': 60,    # number of lookback
            'generative_alpha': 10, # used to regulate user training
            'generative_beta': 10, # used to regulate user training
            'weight_decay': 1e-2
        },
